...
/****** Object:  Stored Procedure dbo.UPDATE_BATTLE_RESULT    Script Date: 6/6/2006 6:03:34 PM ******/

-- sungyong 2003.01.15 create

CREATE PROCEDURE [dbo].[UPDATE_BATTLE_RESULT]
@UserId 	varchar(21),
@byNation	tinyint,
@index		smallint
...
DECLARE @nKarusArea tinyint
DECLARE @nElmoArea tinyint
